...
<link href="<{$resources_dir}>/css/base.css" rel="stylesheet">
<link href="<{$resources_dir}>/css/project.min.css" rel="stylesheet">
<link href="<{$resources_dir}>/css/new.css" rel="stylesheet">
...
<script src="<{$resources_dir}>/assets/js/Prompt_message.js"></script>
